...
> **ศัพท์ที่ผู้เล่นเห็น = "แต้มประลอง"** (เข้าชุดหน้า "สนามประลอง") · ในโค้ดยังใช้ `pvp.rating` ตามเดิม — เปลี่ยนแค่ป้าย UI
...
หน้า/แท็บใหม่ (route lazy) แสดง: **แต้มประลอง**ปัจจุบัน + โควต้าบุกที่เหลือ + การ์ดคู่ต่อสู้ ~5 (คน/บอท มี badge) + ปุ่มท้า → replay → ผล
