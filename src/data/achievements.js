...
export const ACHIEVEMENTS = {
  ...
  pet_all: { title: 'นักสะสมตัวจริง',  icon: '🏆', type: 'milestone', trigger: { stat: 'petSpeciesCount', gte: 'ALL_SPECIES' }, desc: 'สะสมสัตว์ครบทุกชนิด', flavor: 'สะสมครบทุกชนิดแล้ว เก่งมาก' },
  quiz_10:  { title: 'เริ่มติว',     icon: '📝', type: 'milestone', trigger: { stat: 'quizDoneTotal', gte: 10 },  desc: 'ทำข้อสอบครบ 10 ข้อ', flavor: 'เริ่มทำข้อสอบแล้ว ก้าวแรกที่ดี' },
  ...
  quiz_100: { title: 'เซียนข้อสอบ', icon: '🎓', type: 'milestone', trigger: { stat: 'quizDoneTotal', gte: 100 }, desc: 'ทำข้อสอบครบ 100 ข้อ', flavor: 'ทำข้อสอบมา 100 ข้อ ขยันสุด ๆ' },
