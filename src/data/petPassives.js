...
/** เพ็ทที่ "กลไกเปลี่ยน" ในรอบพาสสีฟ v2 (P2c + P3a) — ใช้กับแถบแจ้งครั้งเดียวในหน้าเพ็ทเท่านั้น
 *  ไม่ใช่ข้อมูลเกม · อยู่ที่นี่เพราะมีเทสบังคับว่าทุก id ต้องมีอยู่จริง (พิมพ์ผิด = แถบเงียบไปเฉยๆ) */
